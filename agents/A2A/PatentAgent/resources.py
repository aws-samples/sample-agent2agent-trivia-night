...
DATA_SOURCES = {
    ...
    "odp": {
        "name": "USPTO Open Data Portal (ODP) [REMOVED]",
        "description": "Not available in this build. Previously provided metadata, file wrapper data, continuity, assignments.",
        "available": False,
    },
    "patentsview": {
        "name": "PatentsView Patent Search API [REMOVED]",
        "description": "Not available in this build. Previously provided disambiguated inventor/assignee data.",
        "available": False,
    },
    "ptab": {
        "name": "USPTO PTAB API v3 [REMOVED]",
        "description": "Not available in this build. Previously provided PTAB proceedings and decisions.",
        "available": False,
    },
    "office_actions": {
        "name": "USPTO Office Action APIs [REMOVED]",
        "description": "Not available in this build. Previously provided full-text office actions.",
        "available": False,
    },
    "litigation": {
        "name": "USPTO Patent Litigation API [REMOVED]",
        "description": "Not available in this build. Previously provided litigation case records.",
        "available": False,
    },
}
